        ...
        <div className="min-h-screen w-full bg-[#30A758] relative">
          ...
          <div className="py-32">
            ...
            <div className="min-h-[500px] py-10">
              ...
              <div className="grid grid-cols-3 pt-16 pb-8 place-items-center px-[5%] gap-3" data-aos="fade-up">
                <EventCard title="Project 1" desc="" image="" />
                <EventCard title="Project 2" desc="" image="" />
                <EventCard title="Project 3" desc="" image="" />
              </div>
              <div className="button bg-white text-[#38C063] w-fit mx-auto text-[25px] px-[15px] py-[5px] rounded font-bold font-Lato" data-aos="fade-right">
                See More
              </div>
            </div>
            {/* Events */}
