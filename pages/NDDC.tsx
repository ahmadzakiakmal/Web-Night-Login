        ...
        <div className="min-h-screen w-full bg-[#312F2F] relative">
          ...
          <div className="py-32">
            ...
            <div className="min-h-[500px] py-10">
              ...
              <div
                className="button bg-white text-[#252525] w-fit mx-auto text-[25px] px-[15px] py-[5px] rounded font-bold font-Lato"
                data-aos="fade-right"
              >
                See More
              </div>
            ...
            <div className="min-h-[500px] pt-16 pb-8">
              ...
              <div
                className="grid grid-cols-3 py-12 place-items-center px-[5%] gap-3"
                data-aos="fade-up"
              >
